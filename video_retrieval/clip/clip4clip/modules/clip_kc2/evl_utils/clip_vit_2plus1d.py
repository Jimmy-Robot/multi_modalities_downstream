...
def vit_2plus1d_b32(pretrained=True, num_frames=8, drop_path_rate=0.0):
...
def vit_2plus1d_b16(pretrained=True, num_frames=8, drop_path_rate=0.0):
    model = VisionTransformer(
        input_resolution=224,
        patch_size=16,
        width=768,
...
def vit_2plus1d_l14(pretrained=True, num_frames=8, drop_path_rate=0.0):
    model = VisionTransformer(
        input_resolution=224,
        patch_size=14,
        width=1024,
...
def vit_2plus1d_l14_336(pretrained=True, num_frames=8, drop_path_rate=0.0):
    model = VisionTransformer(
