...
class ResidualAttentionBlock(nn.Module):
    def __init__(
        self, d_model, n_head, attn_mask=None, drop_path=0.0, t_size=8, spatial_size=7
    ):
        super().__init__()
...
def vit_2plus1d_dw_bias_b32(pretrained=True, num_frames=8, drop_path_rate=0.0):
...
def vit_2plus1d_dw_bias_b16(
    pretrained=True, num_frames=8, drop_path_rate=0.0, t_size=8
):
    model = VisionTransformer(
        input_resolution=224,
        patch_size=16,
...
def vit_2plus1d_dw_bias_l14(pretrained=True, num_frames=8, drop_path_rate=0.0):
    model = VisionTransformer(
        input_resolution=224,
        patch_size=14,
        width=1024,
...
def vit_2plus1d_dw_bias_l14_336(pretrained=True, num_frames=8, drop_path_rate=0.0):
    model = VisionTransformer(
