# --------------------------------------------------------
# Based on InternVideo code bases
# InternVideo/Downstream/Video-Text-Retrieval/dataloaders/rawvideo_util.py
# --------------------------------------------------------'
...
class RawVideoExtractorCV2:
    ...
    def video_to_tensor(
        self, cap, preprocess, sample_fp=0, start_time=None, end_time=None
    ):
    ...
    def get_video_data(self, cap, start_time=None, end_time=None):
